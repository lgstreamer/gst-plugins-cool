...
GST_EXPORT
GstCaps * negotiate_default_caps                (GstCaps * input_caps, GstPad * srcpad, gint stream_type);

GST_EXPORT
void make_unsupported_codec                     (const GstCaps * input_caps);

GST_EXPORT
GstStructure * get_smart_property_from_source   (GstElement * parent);
