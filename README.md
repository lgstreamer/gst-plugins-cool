LG webOS 5.x GStreamer - Cool Plugins
=====================================

## Description

This directory contains the gst-plugins-cool source, as compiled by LG to be
...
```
git clone https://github.com/lgstreamer/gst-plugins-cool.git
cd gst-plugins-cool
...
./autogen.sh --host=arm-webos-linux-gnueabi --with-sysroot=${SDKTARGETSYSROOT} \
  ...
  --disable-gtk-doc --disable-examples --disable-debug --disable-static --disable-valgrind \
  --disable-cencdrm --disable-dashsink --disable-dvrdashdemux --disable-dvrtsdemux
./fix_sysroot.sh
make -j6
```
