...
#include <gst/gst.h>
#include <gst/dvrmpegts/gstmpegtssection.h>
#include <gst/dvrmpegts/gstmpegtsdescriptor.h>
...
typedef struct _GstMpegtsAtscVCTSource GstDvrMpegtsAtscVCTSource;
typedef struct _GstMpegtsAtscVCT GstDvrMpegtsAtscVCT;

/**
 * GstDvrMpegtsAtscVCTSource:
 * @descriptors: (element-type GstMpegtsDescriptor): descriptors
 *
 * Source from a @GstDvrMpegtsAtscVCT, can be used both for TVCT and CVCT tables
 */
...
/**
 * GstDvrMpegtsAtscVCT:
 * @sources: (element-type GstDvrMpegtsAtscVCTSource): sources
 * @descriptors: (element-type GstMpegtsDescriptor): descriptors
 *
 * Represents both:
...
GST_MPEGTS_API
const GstDvrMpegtsAtscVCT * gst_mpegts_section_get_atsc_tvct (GstMpegtsSection * section);

GST_MPEGTS_API
const GstDvrMpegtsAtscVCT * gst_mpegts_section_get_atsc_cvct (GstMpegtsSection * section);
...
typedef struct _GstMpegtsAtscMGTTable GstDvrMpegtsAtscMGTTable;
typedef struct _GstMpegtsAtscMGT GstDvrMpegtsAtscMGT;
...
/**
 * GstDvrMpegtsAtscMGTTable:
 * @descriptors: (element-type GstMpegtsDescriptor): descriptors
 *
 * Source from a @GstDvrMpegtsAtscMGT
 */
...
/**
 * GstDvrMpegtsAtscMGT:
 * @tables: (element-type GstDvrMpegtsAtscMGTTable): the tables
 * @descriptors: (element-type GstMpegtsDescriptor): descriptors
 *
...
GST_MPEGTS_API
const GstDvrMpegtsAtscMGT * gst_mpegts_section_get_atsc_mgt (GstMpegtsSection * section);
...
typedef struct _GstMpegtsAtscStringSegment GstDvrMpegtsAtscStringSegment;
typedef struct _GstMpegtsAtscMultString GstDvrMpegtsAtscMultString;
...
GST_MPEGTS_API
const gchar * gst_mpegts_atsc_string_segment_get_string (GstDvrMpegtsAtscStringSegment * seg);

/**
 * GstDvrMpegtsAtscMultString:
 * @segments: (element-type GstDvrMpegtsAtscStringSegment)
 *
 */
...
typedef struct _GstMpegtsAtscEITEvent GstDvrMpegtsAtscEITEvent;
typedef struct _GstMpegtsAtscEIT GstDvrMpegtsAtscEIT;

/**
 * GstDvrMpegtsAtscEITEvent:
 * @titles: (element-type GstDvrMpegtsAtscMultString): the titles
 * @descriptors: (element-type GstMpegtsDescriptor): descriptors
 *
 * An ATSC EIT Event
 */
...
/**
 * GstDvrMpegtsAtscEIT:
 * @events: (element-type GstDvrMpegtsAtscEITEvent): Events
 *
...
GST_MPEGTS_API
const GstDvrMpegtsAtscEIT *gst_mpegts_section_get_atsc_eit (GstMpegtsSection *section);

/* ETT */

#define GST_TYPE_MPEGTS_ATSC_ETT (gst_mpegts_atsc_ett_get_type())

typedef struct _GstMpegtsAtscETT GstDvrMpegtsAtscETT;

/**
 * GstDvrMpegtsAtscETT:
 * @messages: (element-type GstDvrMpegtsAtscMultString): List of texts
 *
...
GST_MPEGTS_API
const GstDvrMpegtsAtscETT *gst_mpegts_section_get_atsc_ett (GstMpegtsSection *section);

/* STT */
#define GST_TYPE_MPEGTS_ATSC_STT (gst_mpegts_atsc_stt_get_type ())

typedef struct _GstMpegtsAtscSTT GstDvrMpegtsAtscSTT;
...
GST_MPEGTS_API
const GstDvrMpegtsAtscSTT * gst_mpegts_section_get_atsc_stt (GstMpegtsSection * section);
/* FIXME receive a non-const parameter but we only provide a const getter */

GST_MPEGTS_API
GstDateTime * gst_mpegts_atsc_stt_get_datetime_utc (GstDvrMpegtsAtscSTT * stt);
