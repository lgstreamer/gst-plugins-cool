...
#include <gst/gst.h>
#include <gst/dvrmpegts/mpegts-prelude.h>
 ...
 *
 * The type of #GstDvrMpegtsDescriptor
 *
...
GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_network_name (const GstDvrMpegtsDescriptor *descriptor,
						       gchar **name);

GST_MPEGTS_API
GstDvrMpegtsDescriptor *gst_mpegts_descriptor_from_dvb_network_name (const gchar * name);

/* GST_MTS_DESC_DVB_STUFFING (0x42) */

GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_stuffing (const GstDvrMpegtsDescriptor * descriptor,
...
GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_satellite_delivery_system (const GstDvrMpegtsDescriptor *descriptor,
...
GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_cable_delivery_system (const GstDvrMpegtsDescriptor *descriptor,
							    GstMpegtsCableDeliverySystemDescriptor *res);

/* GST_MTS_DESC_DVB_BOUQUET_NAME (0x47) */

GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_bouquet_name (const GstDvrMpegtsDescriptor * descriptor,
                                                       gchar ** bouquet_name);
...
GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_service (const GstDvrMpegtsDescriptor *descriptor,
						  GstMpegtsDVBServiceType *service_type,
						  gchar **service_name,
						  gchar **provider_name);

GST_MPEGTS_API
GstDvrMpegtsDescriptor *gst_mpegts_descriptor_from_dvb_service (GstMpegtsDVBServiceType service_type,
							     const gchar * service_name,
							     const gchar * service_provider);

GST_EXPORT
const GstDvrMpegtsDescriptor *gst_mpegts_find_dvb_extension_descriptor (GPtrArray * descriptor,
...
GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_service_list (const GstDvrMpegtsDescriptor * descriptor,
    GPtrArray ** list);
...
typedef struct _GstMpegtsDVBLinkageDescriptor GstDvrMpegtsDVBLinkageDescriptor;
...
/**
 * GstDvrMpegtsDVBLinkageDescriptor:
...
GST_MPEGTS_API
void gst_dvrmpegts_dvb_linkage_descriptor_free (GstDvrMpegtsDVBLinkageDescriptor * source);

GST_MPEGTS_API
const GstMpegtsDVBLinkageMobileHandOver * gst_mpegts_dvb_linkage_descriptor_get_mobile_hand_over
    (const GstDvrMpegtsDVBLinkageDescriptor * desc);
...
GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_linkage (const GstDvrMpegtsDescriptor * descriptor,
                                                  GstDvrMpegtsDVBLinkageDescriptor ** res);

/* GST_MTS_DESC_DVB_SHORT_EVENT (0x4D) */

GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_short_event (const GstDvrMpegtsDescriptor *descriptor,
						       gchar **language_code,
						       gchar **event_name,
						       gchar **text);

/* GST_MTS_DESC_DVB_EXTENDED_EVENT (0x4E) */
typedef struct _GstMpegtsExtendedEventDescriptor GstDvrMpegtsExtendedEventDescriptor;
...
/**
 * GstDvrMpegtsExtendedEventDescriptor:
 * @descriptor_number:
...
GST_MPEGTS_API
void gst_dvrmpegts_extended_event_descriptor_free (GstDvrMpegtsExtendedEventDescriptor * source);

GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_extended_event (const GstDvrMpegtsDescriptor *descriptor,
...
typedef struct _GstMpegtsComponentDescriptor GstDvrMpegtsComponentDescriptor;
...
GST_MPEGTS_API
void gst_dvrmpegts_dvb_component_descriptor_free (GstDvrMpegtsComponentDescriptor * source);

GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_component (const GstDvrMpegtsDescriptor *descriptor,
						    GstDvrMpegtsComponentDescriptor **res);

/* GST_MTS_DESC_DVB_STREAM_IDENTIFIER (0x52) */

GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_stream_identifier (const GstDvrMpegtsDescriptor *descriptor,
							    guint8 *component_tag);

/* GST_MTS_DESC_DVB_CA_IDENTIFIER (0x53) */

GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_ca_identifier (const GstDvrMpegtsDescriptor * descriptor,
                                                        GArray ** list);
...
GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_content (const GstDvrMpegtsDescriptor *
...
GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_parental_rating (const GstDvrMpegtsDescriptor
...
GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_teletext_idx (const GstDvrMpegtsDescriptor *
    descriptor, guint idx, gchar ** language_code,
    GstMpegtsDVBTeletextType * teletext_type, guint8 * magazine_number,
    guint8 * page_number);

GST_MPEGTS_API
guint gst_mpegts_descriptor_parse_dvb_teletext_nb (const GstDvrMpegtsDescriptor *
    descriptor);

/* GST_MTS_DESC_DVB_SUBTITLING (0x59) */

GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_subtitling_idx (const GstDvrMpegtsDescriptor *descriptor,
							 guint idx, gchar ** lang,
							 guint8 *type, guint16 *composition_page_id,
							 guint16 *ancillary_page_id);

GST_MPEGTS_API
guint gst_mpegts_descriptor_parse_dvb_subtitling_nb (const GstDvrMpegtsDescriptor *descriptor);

GST_MPEGTS_API
GstDvrMpegtsDescriptor * gst_mpegts_descriptor_from_dvb_subtitling (const gchar *lang,
...
GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_terrestrial_delivery_system (const GstDvrMpegtsDescriptor
...
GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_multilingual_network_name (const GstDvrMpegtsDescriptor
...
GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_multilingual_bouquet_name (const GstDvrMpegtsDescriptor
...
GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_multilingual_service_name (const GstDvrMpegtsDescriptor
...
GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_multilingual_component (const GstDvrMpegtsDescriptor
              *descriptor, guint8 * component_tag, GPtrArray ** component_description_items);

/* GST_MTS_DESC_DVB_PRIVATE_DATA_SPECIFIER (0x5F) */

GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_private_data_specifier (const GstDvrMpegtsDescriptor
...
GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_frequency_list (const GstDvrMpegtsDescriptor
    * descriptor, gboolean * offset, GArray ** list);

/* GST_MTS_DESC_DVB_DATA_BROADCAST (0x64) */
typedef struct _GstMpegtsDataBroadcastDescriptor GstDvrMpegtsDataBroadcastDescriptor;

/**
 * GstDvrMpegtsDataBroadcastDescriptor:
...
GST_MPEGTS_API
void gst_dvrmpegts_dvb_data_broadcast_descriptor_free (GstDvrMpegtsDataBroadcastDescriptor * source);

GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_data_broadcast (const GstDvrMpegtsDescriptor
              *descriptor, GstDvrMpegtsDataBroadcastDescriptor ** res);
...
GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_scrambling (const GstDvrMpegtsDescriptor * descriptor,
       GstMpegtsDVBScramblingModeType * scrambling_mode);

/* GST_MTS_DESC_DVB_DATA_BROADCAST_ID (0x66) */

GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_data_broadcast_id (const GstDvrMpegtsDescriptor
...
typedef struct _GstMpegtsT2DeliverySystemDescriptor GstDvrMpegtsT2DeliverySystemDescriptor;

/**
 * GstDvrMpegtsT2DeliverySystemDescriptor:
 * @plp_id:
 * @t2_system_id:
 * @siso_miso:
 * @bandwidth:
...
GST_MPEGTS_API
void gst_mpegts_t2_delivery_system_descriptor_free (GstDvrMpegtsT2DeliverySystemDescriptor * source);

GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_dvb_t2_delivery_system (const GstDvrMpegtsDescriptor
              *descriptor, GstDvrMpegtsT2DeliverySystemDescriptor ** res);
