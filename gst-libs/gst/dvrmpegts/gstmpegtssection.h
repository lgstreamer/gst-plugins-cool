...
#include <../gst/dvrtsdemux/gstmpegdefs.h>
...
typedef struct _GstMpegtsPatProgram GstDvrMpegtsPatProgram;
/**
...
GST_MPEGTS_API
GstDvrMpegtsPatProgram *gst_mpegts_pat_program_new (void);
...
/* PMT */
typedef struct _GstMpegtsPMTStream GstDvrMpegtsPMTStream;
typedef struct _GstMpegtsPMT GstDvrMpegtsPMT;
 ...
 * @streams: (element-type GstDvrMpegtsPMTStream): Array of #GstDvrMpegtsPMTStream
 *
...
GST_MPEGTS_API
GstDvrMpegtsPMT *gst_mpegts_pmt_new (void);

GST_MPEGTS_API
GstDvrMpegtsPMTStream *gst_mpegts_pmt_stream_new (void);

GST_MPEGTS_API
const GstDvrMpegtsPMT *gst_mpegts_section_get_pmt (GstMpegtsSection *section);

GST_MPEGTS_API
GstMpegtsSection *gst_mpegts_section_from_pmt (GstDvrMpegtsPMT *pmt, guint16 pid);
