 ...
 * @descriptor: a %GST_MTS_DESC_DVB_NETWORK_NAME #GstDvrMpegtsDescriptor
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_network_name (const GstDvrMpegtsDescriptor *
 ...
 *
 * Creates a #GstDvrMpegtsDescriptor to be a %GST_MTS_DESC_DVB_NETWORK_NAME,
 * with the network name @name. The data field of the #GstDvrMpegtsDescriptor
 * will be allocated, and transferred to the caller.
 *
 * Returns: (transfer full): the #GstDvrMpegtsDescriptor or %NULL on fail
 */
GstDvrMpegtsDescriptor *
 ...
 * @descriptor: a %GST_MTS_DESC_DVB_SERVICE_LIST #GstDvrMpegtsDescriptor
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_service_list (const GstDvrMpegtsDescriptor *
 ...
 * @descriptor: a %GST_MTS_DESC_DVB_STUFFING #GstDvrMpegtsDescriptor
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_stuffing (const GstDvrMpegtsDescriptor *
 ...
 * @descriptor: a %GST_MTS_DESC_DVB_SATELLITE_DELIVERY_SYSTEM #GstDvrMpegtsDescriptor
 ...
 */
gboolean
gst_mpegts_descriptor_parse_satellite_delivery_system (const GstDvrMpegtsDescriptor
 ...
 * @descriptor: a %GST_MTS_DESC_DVB_CABLE_DELIVERY_SYSTEM #GstDvrMpegtsDescriptor
 ...
 */
gboolean
gst_mpegts_descriptor_parse_cable_delivery_system (const GstDvrMpegtsDescriptor *
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_bouquet_name (const GstDvrMpegtsDescriptor *
 ...
 * @descriptor: a %GST_MTS_DESC_DVB_SERVICE #GstDvrMpegtsDescriptor
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_service (const GstDvrMpegtsDescriptor *
 ...
 *
 * Fills a #GstDvrMpegtsDescriptor to be a %GST_MTS_DESC_DVB_SERVICE.
 * The data field of the #GstDvrMpegtsDescriptor will be allocated,
...
{
  GstDvrMpegtsDescriptor *descriptor = NULL;
    ...
    guint8 tag_extension)
{
  ...
  for (i = 0; i < nb_desc; i++) {
    GstDvrMpegtsDescriptor *desc = g_ptr_array_index (descriptor, i);
    if (desc->tag == tag && desc->tag_extension == tag_extension)
      return (const GstDvrMpegtsDescriptor *) desc;
  }
  return NULL;
}

/* GST_MTS_DESC_DVB_LINKAGE (0x4A) */
static GstDvrMpegtsDVBLinkageDescriptor *
_gst_dvrmpegts_dvb_linkage_descriptor_copy (GstDvrMpegtsDVBLinkageDescriptor * source)
{
  GstDvrMpegtsDVBLinkageDescriptor *copy;

  copy = g_slice_dup (GstDvrMpegtsDVBLinkageDescriptor, source);
...
void
gst_dvrmpegts_dvb_linkage_descriptor_free (GstDvrMpegtsDVBLinkageDescriptor * source)
{
  ...
  g_slice_free (GstDvrMpegtsDVBLinkageDescriptor, source);
}

G_DEFINE_BOXED_TYPE (GstDvrMpegtsDVBLinkageDescriptor,
    gst_dvrmpegts_dvb_linkage_descriptor,
    (GBoxedCopyFunc) _gst_dvrmpegts_dvb_linkage_descriptor_copy,
    (GFreeFunc) gst_dvrmpegts_dvb_linkage_descriptor_free);
 ...
 * @descriptor: a %GST_MTS_DESC_DVB_LINKAGE #GstDvrMpegtsDescriptor
 * @res: (out) (transfer full): the #GstDvrMpegtsDVBLinkageDescriptor to fill
 *
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_linkage (const GstDvrMpegtsDescriptor * descriptor,
    GstDvrMpegtsDVBLinkageDescriptor ** desc)
{
  guint i;
  guint8 *data, *end;
  GstDvrMpegtsDVBLinkageDescriptor *res;
  ...
  res = g_slice_new0 (GstDvrMpegtsDVBLinkageDescriptor);
...
fail:
  gst_dvrmpegts_dvb_linkage_descriptor_free (res);
  return FALSE;
}

/**
 * gst_mpegts_dvb_linkage_descriptor_get_mobile_hand_over:
 * @desc: the #GstDvrMpegtsDVBLinkageDescriptor
 *
...
gst_mpegts_dvb_linkage_descriptor_get_event (const GstDvrMpegtsDVBLinkageDescriptor
    * desc)
{
  g_return_val_if_fail (desc != NULL, NULL);
  g_return_val_if_fail (desc->linkage_type ==
 ...
 * @descriptor: a %GST_MTS_DESC_DVB_SHORT_EVENT #GstDvrMpegtsDescriptor
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_short_event (const GstDvrMpegtsDescriptor *
 ...
 * @descriptor: a %GST_MTS_DESC_DVB_TELETEXT #GstDvrMpegtsDescriptor
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_teletext_idx (const GstDvrMpegtsDescriptor *
 ...
 */
guint
gst_mpegts_descriptor_parse_dvb_teletext_nb (const GstDvrMpegtsDescriptor *
    descriptor)
{
 ...
 * @descriptor: a %GST_MTS_DESC_DVB_SUBTITLING #GstDvrMpegtsDescriptor
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_subtitling_idx (const GstDvrMpegtsDescriptor *
 ...
 */
guint
gst_mpegts_descriptor_parse_dvb_subtitling_nb (const GstDvrMpegtsDescriptor *
    descriptor)
{
  g_return_val_if_fail (descriptor != NULL, FALSE);
  __common_desc_check_base (descriptor, GST_MTS_DESC_DVB_SUBTITLING, FALSE);
...
static GstDvrMpegtsExtendedEventDescriptor *
_gst_dvrmpegts_extended_event_descriptor_copy (GstDvrMpegtsExtendedEventDescriptor *
    source)
{
  GstDvrMpegtsExtendedEventDescriptor *copy;

  copy = g_slice_dup (GstDvrMpegtsExtendedEventDescriptor, source);
...
void
gst_dvrmpegts_extended_event_descriptor_free (GstDvrMpegtsExtendedEventDescriptor *
    source)
{
  g_free (source->text);
  g_free (source->language_code);
  g_ptr_array_unref (source->items);
  g_slice_free (GstDvrMpegtsExtendedEventDescriptor, source);
}

G_DEFINE_BOXED_TYPE (GstDvrMpegtsExtendedEventDescriptor,
    gst_dvrmpegts_extended_event_descriptor,
    (GBoxedCopyFunc) _gst_dvrmpegts_extended_event_descriptor_copy,
    (GFreeFunc) gst_dvrmpegts_extended_event_descriptor_free);
 ...
 * @descriptor: a %GST_MTS_DESC_DVB_EXTENDED_EVENT #GstDvrMpegtsDescriptor
 * @res: (out) (transfer full): the #GstDvrMpegtsExtendedEventDescriptor to fill
 *
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_extended_event (const GstDvrMpegtsDescriptor
    * descriptor, GstDvrMpegtsExtendedEventDescriptor ** desc)
{
  guint8 *data, *pdata;
  guint8 tmp, len_item;
  GstMpegtsExtendedEventItem *item;
  GstDvrMpegtsExtendedEventDescriptor *res;
  ...
  res = g_slice_new0 (GstDvrMpegtsExtendedEventDescriptor);
  ...
  if (len_item > descriptor->length - 5) {
    gst_dvrmpegts_extended_event_descriptor_free (res);
    return FALSE;
  }
...
static GstDvrMpegtsComponentDescriptor *
_gst_dvrmpegts_dvb_component_descriptor_copy (GstDvrMpegtsComponentDescriptor *
    source)
{
  GstDvrMpegtsComponentDescriptor *copy;

  copy = g_slice_dup (GstDvrMpegtsComponentDescriptor, source);
...
void
gst_dvrmpegts_dvb_component_descriptor_free (GstDvrMpegtsComponentDescriptor * source)
{
  g_free (source->language_code);
  g_free (source->text);
  g_slice_free (GstDvrMpegtsComponentDescriptor, source);
}

G_DEFINE_BOXED_TYPE (GstDvrMpegtsComponentDescriptor,
    gst_dvrmpegts_component_descriptor,
    (GBoxedCopyFunc) _gst_dvrmpegts_dvb_component_descriptor_copy,
    (GFreeFunc) gst_dvrmpegts_dvb_component_descriptor_free);

/**
 * gst_mpegts_descriptor_parse_dvb_component:
 * @descriptor: a %GST_MTS_DESC_DVB_COMPONENT #GstDvrMpegtsDescriptor
 * @res: (out) (transfer full): the #GstDvrMpegtsComponentDescriptor to fill
 *
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_component (const GstDvrMpegtsDescriptor
    * descriptor, GstDvrMpegtsComponentDescriptor ** res)
{
  guint8 *data;
  guint8 len;
  GstDvrMpegtsComponentDescriptor *desc;
  ...
  desc = g_slice_new0 (GstDvrMpegtsComponentDescriptor);
 ...
 * @descriptor: a %GST_MTS_DESC_DVB_CONTENT #GstDvrMpegtsDescriptor
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_stream_identifier (const GstDvrMpegtsDescriptor
 ...
 * @descriptor: a %GST_MTS_DESC_DVB_CA_IDENTIFIER #GstDvrMpegtsDescriptor
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_ca_identifier (const GstDvrMpegtsDescriptor *
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_content (const GstDvrMpegtsDescriptor
 ...
 * @descriptor: a %GST_MTS_DESC_DVB_PARENTAL_RATING #GstDvrMpegtsDescriptor
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_parental_rating (const GstDvrMpegtsDescriptor
 ...
 * @descriptor: a %GST_MTS_DESC_DVB_TERRESTRIAL_DELIVERY_SYSTEM #GstDvrMpegtsDescriptor
...
gst_mpegts_descriptor_parse_dvb_multilingual_network_name (const
    GstDvrMpegtsDescriptor * descriptor, GPtrArray ** network_name_items)
{
  guint8 *data, i, len;
  GstMpegtsDvbMultilingualNetworkNameItem *item;
...
gst_mpegts_descriptor_parse_dvb_multilingual_bouquet_name (const
    GstDvrMpegtsDescriptor * descriptor, GPtrArray ** bouquet_name_items)
{
  guint8 *data, i, len;
  GstMpegtsDvbMultilingualBouquetNameItem *item;
...
gst_mpegts_descriptor_parse_dvb_multilingual_service_name (const
    GstDvrMpegtsDescriptor * descriptor, GPtrArray ** service_name_items)
{
  guint8 *data, i, len;
  GstMpegtsDvbMultilingualServiceNameItem *item;
...
gst_mpegts_descriptor_parse_dvb_multilingual_component (const
    GstDvrMpegtsDescriptor * descriptor, guint8 * component_tag,
 ...
 * @descriptor: a %GST_MTS_DESC_DVB_PRIVATE_DATA_SPECIFIER #GstDvrMpegtsDescriptor
...
gst_mpegts_descriptor_parse_dvb_private_data_specifier (const
    GstDvrMpegtsDescriptor * descriptor, guint32 * private_data_specifier,
 ...
 * @descriptor: a %GST_MTS_DESC_DVB_FREQUENCY_LIST #GstDvrMpegtsDescriptor
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_frequency_list (const GstDvrMpegtsDescriptor
...
static GstDvrMpegtsDataBroadcastDescriptor *
_gst_dvrmpegts_dvb_data_broadcast_descriptor_copy (GstDvrMpegtsDataBroadcastDescriptor
    * source)
{
  GstDvrMpegtsDataBroadcastDescriptor *copy;

  copy = g_slice_dup (GstDvrMpegtsDataBroadcastDescriptor, source);
...
void
gst_dvrmpegts_dvb_data_broadcast_descriptor_free (GstDvrMpegtsDataBroadcastDescriptor
    * source)
{
  g_free (source->selector_bytes);
  g_free (source->language_code);
  g_free (source->text);
  g_slice_free (GstDvrMpegtsDataBroadcastDescriptor, source);
}

G_DEFINE_BOXED_TYPE (GstDvrMpegtsDataBroadcastDescriptor,
    gst_dvrmpegts_dvb_data_broadcast_descriptor,
    (GBoxedCopyFunc) _gst_dvrmpegts_dvb_data_broadcast_descriptor_copy,
    (GFreeFunc) gst_dvrmpegts_dvb_data_broadcast_descriptor_free);

/**
 * gst_mpegts_descriptor_parse_dvb_data_broadcast:
 * @descriptor: a %GST_MTS_DESC_DVB_DATA_BROADCAST #GstDvrMpegtsDescriptor
 * @res: (out) (transfer full): #GstDvrMpegtsDataBroadcastDescriptor
 *
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_data_broadcast (const GstDvrMpegtsDescriptor
    * descriptor, GstDvrMpegtsDataBroadcastDescriptor ** desc)
{
  guint8 *data;
  GstDvrMpegtsDataBroadcastDescriptor *res;
  ...
  res = g_slice_new0 (GstDvrMpegtsDataBroadcastDescriptor);
 ...
 * @descriptor: a %GST_MTS_DESC_DVB_SCRAMBLING #GstDvrMpegtsDescriptor
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_scrambling (const GstDvrMpegtsDescriptor *
 ...
 * @descriptor: a %GST_MTS_DESC_DVB_DATA_BROADCAST_ID #GstDvrMpegtsDescriptor
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_data_broadcast_id (const GstDvrMpegtsDescriptor
...
static GstDvrMpegtsT2DeliverySystemDescriptor
    * _gst_dvrmpegts_t2_delivery_system_descriptor_copy
    (GstDvrMpegtsT2DeliverySystemDescriptor * source)
{
  GstDvrMpegtsT2DeliverySystemDescriptor *copy;

  copy = g_slice_dup (GstDvrMpegtsT2DeliverySystemDescriptor, source);
  copy->cells = g_ptr_array_ref (source->cells);

  return copy;
}

void gst_dvrmpegts_t2_delivery_system_descriptor_free
    (GstDvrMpegtsT2DeliverySystemDescriptor * source)
{
  g_ptr_array_unref (source->cells);
  g_slice_free (GstDvrMpegtsT2DeliverySystemDescriptor, source);
}

G_DEFINE_BOXED_TYPE (GstDvrMpegtsT2DeliverySystemDescriptor,
    gst_dvrmpegts_t2_delivery_system_descriptor,
    (GBoxedCopyFunc) _gst_dvrmpegts_t2_delivery_system_descriptor_copy,
    (GFreeFunc) gst_dvrmpegts_t2_delivery_system_descriptor_free);
 ...
 * @descriptor: a %GST_MTS_DESC_EXT_DVB_T2_DELIVERY_SYSTEM #GstDvrMpegtsDescriptor
 * @res: (out) (transfer full): #GstDvrMpegtsT2DeliverySystemDescriptor
 *
 ...
 */
gboolean
gst_mpegts_descriptor_parse_dvb_t2_delivery_system (const GstDvrMpegtsDescriptor
    * descriptor, GstDvrMpegtsT2DeliverySystemDescriptor ** desc)
{
  guint8 *data;
  guint8 len, freq_len, sub_cell_len;
  guint32 tmp_freq;
  guint8 i;
  GstDvrMpegtsT2DeliverySystemDescriptor *res;
  ...
  res = g_slice_new0 (GstDvrMpegtsT2DeliverySystemDescriptor);
