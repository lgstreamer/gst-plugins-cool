 ...
 * The converted text can be used directly in DVB #GstDvrMpegtsDescriptor
 *
...
_new_descriptor (guint8 tag, guint8 length)
{
  ...
  descriptor = g_slice_new (GstDvrMpegtsDescriptor);
...
static GstDvrMpegtsDescriptor *
_dvrcopy_descriptor (GstDvrMpegtsDescriptor * desc)
{
  GstDvrMpegtsDescriptor *copy;

  copy = g_slice_dup (GstDvrMpegtsDescriptor, desc);
 ...
 */
void
gst_dvrmpegts_descriptor_free (GstDvrMpegtsDescriptor * desc)
{
  g_free ((gpointer) desc->data);
  g_slice_free (GstDvrMpegtsDescriptor, desc);
}

G_DEFINE_BOXED_TYPE (GstDvrMpegtsDescriptor, gst_dvrmpegts_descriptor,
    (GBoxedCopyFunc) _dvrcopy_descriptor,
    (GBoxedFreeFunc) gst_dvrmpegts_descriptor_free);
 ...
 *
 * Returns: (transfer full) (element-type GstDvrMpegtsDescriptor): an
...
gst_mpegts_parse_descriptors (guint8 * buffer, gsize buf_len)
{
  ...
  for (i = 0; i < nb_desc; i++) {
    GstDvrMpegtsDescriptor *desc = g_slice_new0 (GstDvrMpegtsDescriptor);
 ...
 * @descriptors: (element-type GstDvrMpegtsDescriptor) (transfer none): an array
 * of #GstDvrMpegtsDescriptor
 ...
 *
 * Creates a %GST_MTS_DESC_REGISTRATION #GstDvrMpegtsDescriptor
 *
 * Return: #GstDvrMpegtsDescriptor, %NULL on failure
 */
GstDvrMpegtsDescriptor *
 ...
 * @descriptor: a %GST_MTS_DESC_CA #GstDvrMpegtsDescriptor
...
gboolean
gst_mpegts_descriptor_parse_ca (GstDvrMpegtsDescriptor * descriptor,
...
static GstDvrMpegtsISO639LanguageDescriptor *
_gst_dvrmpegts_iso_639_language_descriptor_copy (GstDvrMpegtsISO639LanguageDescriptor
    * source)
{
  GstDvrMpegtsISO639LanguageDescriptor *copy;
  guint i;

  copy = g_slice_dup (GstDvrMpegtsISO639LanguageDescriptor, source);
...
void
gst_dvrmpegts_iso_639_language_descriptor_free (GstDvrMpegtsISO639LanguageDescriptor
    * desc)
{
  guint i;
  ...
  g_slice_free (GstDvrMpegtsISO639LanguageDescriptor, desc);
}

G_DEFINE_BOXED_TYPE (GstDvrMpegtsISO639LanguageDescriptor,
    gst_dvrmpegts_iso_639_language,
    (GBoxedCopyFunc) _gst_dvrmpegts_iso_639_language_descriptor_copy,
    (GFreeFunc) gst_dvrmpegts_iso_639_language_descriptor_free);

/**
 * gst_mpegts_descriptor_parse_iso_639_language:
 * @descriptor: a %GST_MTS_DESC_ISO_639_LANGUAGE #GstDvrMpegtsDescriptor
 * @res: (out) (transfer full): the #GstDvrMpegtsISO639LanguageDescriptor to fill
 *
 ...
 */
gboolean
gst_mpegts_descriptor_parse_iso_639_language (const GstDvrMpegtsDescriptor *
    descriptor, GstDvrMpegtsISO639LanguageDescriptor ** desc)
{
  guint i;
  guint8 *data;
  ...
  res = g_slice_new0 (GstDvrMpegtsISO639LanguageDescriptor);
 ...
 */
gboolean
gst_mpegts_descriptor_parse_iso_639_language_idx (const GstDvrMpegtsDescriptor *
 ...
 */
guint
gst_mpegts_descriptor_parse_iso_639_language_nb (const GstDvrMpegtsDescriptor *
    descriptor)
{
 ...
 *
 * Creates a %GST_MTS_DESC_ISO_639_LANGUAGE #GstDvrMpegtsDescriptor with
 * a single language
 *
 * Return: #GstDvrMpegtsDescriptor, %NULL on failure
 */
 ...
 * @descriptor: a %GST_MTS_DESC_DTG_LOGICAL_CHANNEL #GstDvrMpegtsDescriptor
 ...
 */
gboolean
gst_mpegts_descriptor_parse_logical_channel (const GstDvrMpegtsDescriptor *
 ...
 *
 * Creates a #GstDvrMpegtsDescriptor with custom @tag and @data
 *
 * Returns: #GstDvrMpegtsDescriptor
 */
GstDvrMpegtsDescriptor *
 ...
 * @length: length of @data
 *
 * Creates a #GstDvrMpegtsDescriptor with custom @tag, @tag_extension and @data
 *
 * Returns: #GstDvrMpegtsDescriptor
 */
GstDvrMpegtsDescriptor *
