...
typedef struct _GstMpegtsDescriptor GstDvrMpegtsDescriptor;
...
GST_MPEGTS_API
void       gst_dvrmpegts_descriptor_free (GstDvrMpegtsDescriptor *desc);

GST_MPEGTS_API
GPtrArray *gst_mpegts_parse_descriptors (guint8 * buffer, gsize buf_len);

GST_MPEGTS_API
const GstDvrMpegtsDescriptor * gst_mpegts_find_descriptor (GPtrArray *descriptors,
							guint8 tag);

/* GST_MTS_DESC_REGISTRATION (0x05) */

GST_MPEGTS_API
GstDvrMpegtsDescriptor *gst_mpegts_descriptor_from_registration (
...
GST_MPEGTS_API
gboolean  gst_mpegts_descriptor_parse_ca (GstDvrMpegtsDescriptor *descriptor,
...
typedef struct _GstMpegtsISO639LanguageDescriptor GstDvrMpegtsISO639LanguageDescriptor;
...
GST_MPEGTS_API
void gst_dvrmpegts_iso_639_language_descriptor_free (GstDvrMpegtsISO639LanguageDescriptor * desc);

GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_iso_639_language (const GstDvrMpegtsDescriptor *descriptor,
						       GstDvrMpegtsISO639LanguageDescriptor **res);

GST_MPEGTS_API
gboolean gst_mpegts_descriptor_parse_iso_639_language_idx (const GstDvrMpegtsDescriptor *descriptor,
                                                           guint idx, gchar **lang,
                                                           GstMpegtsIso639AudioType *audio_type);

GST_MPEGTS_API
guint gst_mpegts_descriptor_parse_iso_639_language_nb (const GstDvrMpegtsDescriptor *descriptor);

GST_MPEGTS_API
GstDvrMpegtsDescriptor * gst_mpegts_descriptor_from_iso_639_language (const gchar * language);
...
GST_MPEGTS_API
gboolean
gst_mpegts_descriptor_parse_logical_channel (const GstDvrMpegtsDescriptor *descriptor,
