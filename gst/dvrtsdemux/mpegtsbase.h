...
G_GNUC_INTERNAL const GstDvrMpegtsDescriptor *mpegts_get_descriptor_from_stream (MpegTSBaseStream * stream, guint8 tag);
G_GNUC_INTERNAL const GstDvrMpegtsDescriptor *mpegts_get_descriptor_from_program (MpegTSBaseProgram * program, guint8 tag);

G_GNUC_INTERNAL const GstDvrMpegtsDescriptor *mpegts_get_dvb_extension_descriptor_from_stream (MpegTSBaseStream * stream, guint8 tag, guint8 tag_extension);
