...
G_GNUC_INTERNAL GstDvrMpegtsDescriptor *_new_descriptor (guint8 tag, guint8 length);
G_GNUC_INTERNAL GstDvrMpegtsDescriptor *_new_descriptor_with_extension (guint8 tag,
