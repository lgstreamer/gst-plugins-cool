...
typedef struct _GstMpegtsNITStream GstDvrMpegtsNITStream;
typedef struct _GstMpegtsNIT GstDvrMpegtsNIT;
 ...
 * @streams: (element-type GstDvrMpegtsNITStream): the streams
 *
...
GST_MPEGTS_API
const GstDvrMpegtsNIT *gst_mpegts_section_get_nit (GstMpegtsSection *section);

GST_MPEGTS_API
GstMpegtsSection *gst_mpegts_section_from_nit (GstDvrMpegtsNIT *nit);

GST_MPEGTS_API
GstDvrMpegtsNIT *gst_mpegts_nit_new (void);

GST_MPEGTS_API
GstDvrMpegtsNITStream *gst_mpegts_nit_stream_new (void);


/* BAT */

typedef struct _GstMpegtsBATStream GstDvrMpegtsBATStream;
typedef struct _GstMpegtsBAT GstDvrMpegtsBAT;
 ...
 * GstDvrMpegtsBAT:
 * @descriptors: (element-type GstMpegtsDescriptor):
 * @streams: (element-type GstDvrMpegtsBATStream):
 *
...
GST_MPEGTS_API
const GstDvrMpegtsBAT *gst_mpegts_section_get_bat (GstMpegtsSection *section);

/* SDT */
#define GST_TYPE_MPEGTS_SDT (gst_mpegts_sdt_get_type())
#define GST_TYPE_MPEGTS_SDT_SERVICE (gst_mpegts_sdt_service_get_type())

typedef struct _GstMpegtsSDTService GstDvrMpegtsSDTService;
typedef struct _GstMpegtsSDT GstDvrMpegtsSDT;
 ...
 * @services: (element-type GstDvrMpegtsSDTService): List of services
 *
...
GST_MPEGTS_API
const GstDvrMpegtsSDT *gst_mpegts_section_get_sdt (GstMpegtsSection *section);

GST_MPEGTS_API
GstMpegtsSection *gst_mpegts_section_from_sdt (GstDvrMpegtsSDT * sdt);

GST_MPEGTS_API
GstDvrMpegtsSDT *gst_mpegts_sdt_new (void);

GST_MPEGTS_API
GstDvrMpegtsSDTService *gst_mpegts_sdt_service_new (void);
...
typedef struct _GstMpegtsEITEvent GstDvrMpegtsEITEvent;
typedef struct _GstMpegtsEIT GstDvrMpegtsEIT;

/**
 * GstDvrMpegtsEITEvent:
 * @descriptors: (element-type GstMpegtsDescriptor): List of descriptors
 *
 * Event from a @GstDvrMpegtsEIT
 */
...
/**
 * GstDvrMpegtsEIT:
 * @events: (element-type GstDvrMpegtsEITEvent): List of events
 *
...
GST_MPEGTS_API
const GstDvrMpegtsEIT *gst_mpegts_section_get_eit (GstMpegtsSection *section);
...
typedef struct _GstMpegtsTOT GstDvrMpegtsTOT;
...
GST_MPEGTS_API
const GstDvrMpegtsTOT *gst_mpegts_section_get_tot (GstMpegtsSection *section);
